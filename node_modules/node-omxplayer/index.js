...
function buildArgs (source, givenOutput, loop, initialVolume,alpha, showOsd) {
	let output = '';
	...
	// Handle the initial alpha argument, if provided
...
function Omx (source, output, loop, initialVolume,alpha, showOsd) {
	...
	function spawnPlayer (src, out, loop, initialVolume, alpha, showOsd) {

		let args = buildArgs(src, out, loop, initialVolume, alpha, showOsd);
